...
製造業向けのAI画像検査システム - Azure OpenAI GPT-4.1を活用した部品外観検査の研究・実験プロジェクト

## 📋 プロジェクト概要

このプロジェクトは、製造業における部品の外観検査をAI（Azure OpenAI GPT-4.1）で自動化するための実験を行っています。特に以下の4つのカテゴリでの分類精度向上を目指しています：
...
4. **モデル比較**: GPT-4.1 vs o4-miniのコスト・精度トレードオフ
